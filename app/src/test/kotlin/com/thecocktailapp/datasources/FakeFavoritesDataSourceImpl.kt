...
class FakeFavoritesDataSourceImpl @Inject constructor() : FavoritesDataSource {

    override fun addDrink(drink: DrinkDTO) {}

    override fun isFavoriteDrink(id: Int): Boolean {
        return true
    }

    override fun getAllFavorites(): List<DrinkDTO> = listOf(
        DrinkDTO(
